...
|                                                    |                                   |                                                              |                                                              |           |
| **model_settings**                                 | **Loss type**                     | The available loss functions:<br />1- Mean squared error. (MSE)<br />2- Inverse variance. (IV)<br />3- Batch inverse varaince. (BIV) | 1- mse<br />2- iv<br />3- biv                                |  string   |
...
|                                                    |                                   |                                                              |                                                              |           |
|                                                    |                                   |                                                              |                                                              |           |
| **noise**                                          | **Noise**                         | Enabling noise addition to the labels                        | True or False                                                |  boolean  |
|                                                    |                                   |                                                              |                                                              |           |
|                                                    |                                   |                                                              |                                                              |           |
...
| **distributions_ratio**                            | **Noise distributions ratio (p)** | Probability function over noise variance distributions. This is to study the contribution effect of low and high noise variance distributions. | [0-1]                                                        |   float   |
