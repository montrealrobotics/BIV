...
latex_documents = [
    (master_doc, 'IVUpdate.tex', 'IV Update Documentation',
     'Waleed Khamies', 'manual'),
]
...
man_pages = [
    (master_doc, 'ivupdate', 'IV Update Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'IVUpdate', 'IV Update Documentation',
     author, 'IVUpdate', 'One line description of project.',
     'Miscellaneous'),
]
